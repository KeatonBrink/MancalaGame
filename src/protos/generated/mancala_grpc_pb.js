...
var src_protos_mancala_pb = require('./mancala_pb.js');

function serialize_mancala_HandshakeRequest(arg) {
  if (!(arg instanceof src_protos_mancala_pb.HandshakeRequest)) {
...
function deserialize_mancala_HandshakeRequest(buffer_arg) {
  return src_protos_mancala_pb.HandshakeRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_mancala_HandshakeResponse(arg) {
  if (!(arg instanceof src_protos_mancala_pb.HandshakeResponse)) {
...
function deserialize_mancala_HandshakeResponse(buffer_arg) {
  return src_protos_mancala_pb.HandshakeResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_mancala_MoveRequest(arg) {
  if (!(arg instanceof src_protos_mancala_pb.MoveRequest)) {
...
function deserialize_mancala_MoveRequest(buffer_arg) {
  return src_protos_mancala_pb.MoveRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_mancala_MoveResponse(arg) {
  if (!(arg instanceof src_protos_mancala_pb.MoveResponse)) {
...
function deserialize_mancala_MoveResponse(buffer_arg) {
  return src_protos_mancala_pb.MoveResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_mancala_UpdateRequest(arg) {
  if (!(arg instanceof src_protos_mancala_pb.UpdateRequest)) {
...
function deserialize_mancala_UpdateRequest(buffer_arg) {
  return src_protos_mancala_pb.UpdateRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_mancala_UpdateResponse(arg) {
  if (!(arg instanceof src_protos_mancala_pb.UpdateResponse)) {
...
function deserialize_mancala_UpdateResponse(buffer_arg) {
  return src_protos_mancala_pb.UpdateResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var MancalaServiceService = exports.MancalaServiceService = {
  gameHandshake: {
    ...
    requestType: src_protos_mancala_pb.HandshakeRequest,
    responseType: src_protos_mancala_pb.HandshakeResponse,
  ...
  makeMove: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: src_protos_mancala_pb.MoveRequest,
    responseType: src_protos_mancala_pb.MoveResponse,
  ...
  requestUpdate: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: src_protos_mancala_pb.UpdateRequest,
    responseType: src_protos_mancala_pb.UpdateResponse,
